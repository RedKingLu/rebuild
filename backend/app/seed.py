...
RESOURCE_SEEDS = [
    ...
    {"resource_type": ResourceType.skill, "name": "P 系列平台 Skill（29 个）", "status": ResourceStatus.active, "risk_level": RiskLevel.L1, "source_type": SourceType.community, "source_trust_level": TrustLevel.reviewed_reference, "source_path_or_ref": f"{_S_DIR}/", "description": "24 个源自 ECC(MIT) 改写为信创迁移语境 + 5 个 rebuild 自有 P 阶段主工作流 skill（full-stack-profiler P1 建档 / P-migration-assessment P2 评估 / P-migration-planning P3 规划 / P-migration-execution P4 执行 / P-migration-verification P5 验证，均 D-108），覆盖 P0-P6 + 跨阶段，均有真实 SKILL.md；原 30 候选剔除 6 个非迁移类（市场对标/营销/UI美学/harness运维/工具选型/运维监控）", "type_metadata": {"count": 29, "source_repo": "https://github.com/affaan-m/ECC", "license": "MIT", "dropped_non_migration": ["benchmark-methodology", "content-engine", "design-system", "config-gc", "agent-eval", "dashboard-builder"]}},
